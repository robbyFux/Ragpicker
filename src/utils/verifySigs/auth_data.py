...
from utils.pyasn1 import oids
from utils.pyasn1 import pkcs7
from utils.pyasn1 import spc
from utils.pyasn1.codec.ber import decoder
from utils.pyasn1.codec.der import encoder as der_encoder
...
try:
  ...
  M2_X509 = None
  raise ImportError, 'M2Crypto is required to run this program : http://chandlerproject.org/Projects/MeTooCrypto/ or sudo apt-get install python-m2crypto'
